...
@Slf4j
public class RiskConfigFactory {

    public static MuZeroConfig getRiskInstance() {
        ...
        MuZeroConfig.MuZeroConfigBuilder builder = MuZeroConfig.builder()
                ...
                .modelName("MuZero-Risk")

                .gameClass(Risk.class)
                .actionClass(RiskAction.class)
