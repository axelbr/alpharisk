...
package at.ac.tuwien.ifs.sge.agent.alpharisk.agent.fast.model;
...
import at.ac.tuwien.ifs.sge.agent.alpharisk.agent.fast.model.djl.SubModel;
import at.ac.tuwien.ifs.sge.agent.alpharisk.agent.fast.model.djl.blocks.atraining.MuZeroBlock;
import at.ac.tuwien.ifs.sge.agent.alpharisk.agent.fast.model.djl.blocks.binference.InitialInferenceBlock;
import at.ac.tuwien.ifs.sge.agent.alpharisk.agent.fast.model.djl.blocks.binference.InitialInferenceListTranslator;
import at.ac.tuwien.ifs.sge.agent.alpharisk.agent.fast.model.djl.blocks.binference.RecurrentInferenceBlock;
import at.ac.tuwien.ifs.sge.agent.alpharisk.agent.fast.model.djl.blocks.binference.RecurrentInferenceListTranslator;
import at.ac.tuwien.ifs.sge.agent.alpharisk.agent.fast.model.djl.blocks.cmainfunctions.DynamicsBlock;
import at.ac.tuwien.ifs.sge.agent.alpharisk.agent.fast.model.djl.blocks.cmainfunctions.PredictionBlock;
import at.ac.tuwien.ifs.sge.agent.alpharisk.agent.fast.model.djl.blocks.cmainfunctions.RepresentationBlock;
...
import static at.ac.tuwien.ifs.sge.agent.alpharisk.agent.slow.play.PlayManager.getAllActionsOnDevice;
